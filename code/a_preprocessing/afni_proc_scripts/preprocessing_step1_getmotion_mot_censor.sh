...
mkdir -p ${base_dir}/derivatives/sub-${sub}/ses-${session}/step1_getmotion_mot_censor
cd ${base_dir}/derivatives/sub-${sub}/ses-${session}/step1_getmotion_mot_censor

echo ${base_dir}/sub-${sub}/ses-${session}/step1_getmotion_mot_censor
